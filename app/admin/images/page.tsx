...
const Page: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const result = await fetchImages(perPageCount, 0)
  ...
  const handleShowMore = async () => {
    ...
    try {
      const result = await fetchImages(perPageCount, list.length)
                    ...
                    <tr key={i} className="app__tr">
                      ...
                      <td className="app__td">
                        <div className="flex space-x-2">
                          <span>
                            {`https://nuhirhfevxoonendpfsm.supabase.co/storage/v1/object/public/${item.content}`}
                          </span>
                          <CopyIcon
